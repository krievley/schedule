...
"optionsPanel_label" => "Options Panel",
...
"usr_delete" => "Törlés",
"usr_view" => "Nézet",
"usr_post_own" => "Saját (esemény) hozzáadás",
"usr_post_all" => "Összes (esemény) hozzáadás",
"usr_manager" => "Manager",
"usr_admin" => "Admin",
...
"usr_not_found" => "Felhasználó nem található",
"usr_if_changing_pw" => "Csak ha megváltoztatja a jelszót",
"usr_admin_rights" => "Adminisztrációs funkciók",
"usr_no_rights" => "Nincs hozzáférési jogok",
"usr_view_calendar" => "Naptár megtekintése",
"usr_post_events_own" => "Saját esemény hozzáadás+szerkesztés",
"usr_post_events_all" => "Összes esemény hozzáadás+szerkesztés",
...
"usr_uname_exists" => "Ez a felhasználónév már létezik",
